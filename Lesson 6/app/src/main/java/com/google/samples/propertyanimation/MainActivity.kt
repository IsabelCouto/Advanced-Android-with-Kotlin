...
class MainActivity : AppCompatActivity() {
    ...
    private fun rotater() {
        var animator :ObjectAnimator = ObjectAnimator.ofFloat(star, View.ROTATION,-360f,0f)
    ...
    private fun shower() {
        ...
        newStar.scaleY = newStar.scaleY
        starW *= newStar.scaleX
        starH *= newStar.scaleY

        newStar.translationX = Math.random().toFloat() * containerW -starW /2

        val mover: ObjectAnimator = ObjectAnimator.ofFloat(newStar, View.TRANSLATION_Y, -starH,containerH + starH)
        mover.interpolator = AccelerateInterpolator(1f)
        val rotator:ObjectAnimator = ObjectAnimator.ofFloat(newStar,View.ROTATION, (Math.random()*1080).toFloat())
